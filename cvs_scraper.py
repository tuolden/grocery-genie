...
class CVSScraper:
    ...
    def set_authentication(self, access_token: str, cookies: str, ec_card_no: str, member_ids: List[str]):
        """
    ...
    def get_orders_list(self, months: int = 12, page: int = 1) -> Optional[Dict]:
        """
    ...
    def get_order_details(self, order_number: str, order_type: str = "STORE") -> Optional[Dict]:
        """
    ...
    def save_order_yaml(self, order_data: Dict, output_dir: str = "data/cvs") -> Optional[str]:
        """
...
def main():
    ...
    print(f"📁 YAML files saved to: ./data/cvs")
