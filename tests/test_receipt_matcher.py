...
class ReceiptMatcherTester:
    ...
    def setup_test_data(self):
        ...
        try:
            ...
            # Walmart list items
            test_walmart_items = ["TEST_EGGS", "TEST_CHEESE", "TEST_YOGURT", "TEST_CEREAL"]
            ...
            # CVS list items
            test_cvs_items = ["TEST_VITAMINS", "TEST_SHAMPOO", "TEST_TOOTHPASTE"]
    ...
    def validate_results(self):
        ...
        try:
            ...
            for item in inventory_items:
                logger.info(
                    f"📦 Inventory: {item['item_name']} - {item['store']} - Qty: {item['quantity']} - ${item['price']}"
                )
