...
class PublixListScraper:
    ...
    def get_purchases_page(self, page: int = 1, items_per_page: int = 100) -> Optional[Dict]:
    ...
    def scrape_all_purchases(self) -> None:
        ...
        while True:
            ...
            print(f"📊 Page {page}/{total_pages}: Found {len(purchases)} purchases (Total: {total_count})")
